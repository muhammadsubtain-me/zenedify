    ...
    <div>
      ...
      <section className="bg-white">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 py-14 sm:py-20 lg:py-[60px] grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-10 items-center min-w-0">
          ...
          {/* Image */}
          <div className="animate-float flex justify-center items-center order-2 lg:order-2 px-2 py-8 sm:p-10 sm:pr-[55px] min-w-0 max-w-full overflow-x-clip pr-[20px]">
            <Image
