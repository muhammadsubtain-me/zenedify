    ...
    <div>
      ...
      <section style={{ padding: '80px 24px', background: '#f8fafc' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1.4fr', gap: 60 }}>
          ...
          <div style={{ background: 'white', borderRadius: 20, padding: 40, boxShadow: '0 4px 24px rgba(0,0,0,0.07)', border: '1px solid #e2e8f0' }}>
            {submitted ? (
              ...
              <>
                ...
                <form onSubmit={handleSubmit}>
                  {[
                    ...
                    <div key={f.key} style={{ marginBottom: 20 }}>
                      ...
                      <input
                        ...
                        required
                        style={{ width: '100%', padding: '12px 16px', borderRadius: 10, border: '1.5px solid #e2e8f0', fontSize: 14, fontFamily: 'Poppins,sans-serif', outline: 'none', transition: 'border 0.2s', boxSizing: 'border-box' }}
                  ...
                  <div style={{ marginBottom: 24 }}>
                    <label style={{ display: 'block', fontWeight: 600, fontSize: 14, color: '#374151', marginBottom: 6 }}>Message</label>
                    <textarea
                      ...
                      required
                      rows={5}
                      style={{ width: '100%', padding: '12px 16px', borderRadius: 10, border: '1.5px solid #e2e8f0', fontSize: 14, fontFamily: 'Poppins,sans-serif', outline: 'none', resize: 'vertical', boxSizing: 'border-box' }}
                      onFocus={e => e.target.style.borderColor = '#2563eb'}
                      onBlur={e => e.target.style.borderColor = '#e2e8f0'}
                    />
                  </div>
                  <button type="submit" className="btn-primary" style={{ width: '100%', textAlign: 'center', fontSize: 16 }}>Send Message →</button>
                </form>
              </>
            )}
          </div>
